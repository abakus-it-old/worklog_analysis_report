...
class worklog_analysis_report(models.TransientModel):
    ...
    def get_report_data(self):
        ...
        if self.user_id:
            ...
            hr_analitic_timesheet_obj = self.pool.get('hr.analytic.timesheet')
            ...
            timesheet_ids = hr_analitic_timesheet_obj.search(cr, uid, search_query)
            ...
            for timesheet in hr_analitic_timesheet_obj.browse(cr, uid, timesheet_ids):
                ...
                contract_name = timesheet.account_id.name
                duration = timesheet.unit_amount
                invoiceable = int(100-timesheet.to_invoice.factor)
                ...
                if week_number in week_numbers_dict:
                    ...
                    if date_begin_string in days_dict:
                        ...
                        day["DATA"].append({"DATE": day_date, "CONTRACT_NAME": contract_name, "DURATION": duration, "INVOICEABLE": invoiceable, "DESCRIPTION": description})
                    else:
                        day = {"DAY_NUMBER": day_number,"DATE": date_begin_string, "TOTAL": duration, "DATA": [{"DATE": day_date, "CONTRACT_NAME": contract_name, "DURATION": duration, "INVOICEABLE": invoiceable, "DESCRIPTION": description}]}
